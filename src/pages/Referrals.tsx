...
const Referrals = () => {
  ...
  const referralLink = referralCode
    ? `${siteOrigin}/auth?ref=${referralCode}`
    : "";
      ...
      <main className="flex-1 container py-12 max-w-3xl">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground mt-2">
            Share BeteGubae with friends. When they sign up with your link, you
            both benefit.
          </p>
        </div>
        ...
        {isLoggedIn && referralCode ? (
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">
                  Share this link. When someone signs up using it, you may earn
                  rewards.
                </p>
              </CardHeader>
                    ...
                    >
                      <div>
                        <p className="text-sm font-medium">
                          ETB {Number(request.amount || 0).toFixed(2)}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          {request.createdAt
          ...
          <Card>
            <CardContent className="py-8 text-center">
              <p className="text-muted-foreground">
                You don’t have a referral code yet. Contact support or check
                back later.
              </p>
          ...
          <Card>
            <CardContent className="py-8 text-center">
              ...
              <p className="text-muted-foreground">
                Sign in to get your personal referral link and start earning.
              </p>
              <Button asChild variant="accent" className="mt-4">
        ...
        <div className="mt-8 p-4 rounded-lg bg-muted/50 text-sm text-muted-foreground">
          <p>
            ...
            they create an account and enroll in a course, referral rewards may
